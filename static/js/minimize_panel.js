...
document.getElementById('btn-minimize').addEventListener('click', async () => {
    const data = {
        ...
        transitions: document.getElementById('min-transitions').value
    };
    ...
    document.getElementById('min-explanation-text').innerHTML = `<pre style="font-family: 'JetBrains Mono', monospace; font-size: 0.85rem; color: var(--text); background: #1a1a1a; padding: 1.5rem; border-radius: 6px; border: 1px solid var(--border); overflow-x: auto; margin: 0; line-height: 1.6; white-space: pre-wrap;">${text}</pre>`;
});
